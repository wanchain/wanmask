...
import EthTx from 'wanchainjs-tx'
  ...
  describe('#newUnapprovedTransaction', function () {
    ...
    it('should reject when finished and status is rejected', async function () {
      ...
      await assert.rejects(
        ...
        { message: 'WanMask Tx Signature: User denied transaction signature.' },
      )
    })
  })
  ...
  describe('#addUnapprovedTransaction', function () {
    ...
    it('should fail if netId is loading', async function () {
      ...
      await assert.rejects(
        ...
        { message: 'WanMask is having trouble connecting to the network' },
      )
    })
  })

...
describe('buy-eth-url', function () {
  ...
  //   assert.equal(wyreUrl, 'https://pay.sendwyre.com/?dest=wanchain:0x0dcd5d886577d5081b0c52e242ef29e70be3e7bc&destCurrency=WAN&accountId=AC-7AG3W4XH4N2&paymentMethod=debit-card')
  ...
  it('returns wyre url with address for network 1', function () {
    ...
    assert.equal(wyreUrl, 'https://www.binance.com/')

  })

  it('returns metamask ropsten faucet for network 3', function () {
    const ropstenUrl = getBuyEthUrl(ropsten)
    assert.equal(ropstenUrl, 'https://wanchain-faucet.vercel.app/')
  })
})

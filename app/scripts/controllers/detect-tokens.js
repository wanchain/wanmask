...
import contracts from '@wanchainmask/wan-contract-metadata'
...
export default class DetectTokensController {
  ...
  /**
   * For each token in @wanchainmask/wan-contract-metadata, find check selectedAddress balance.
   */
  async detectNewTokens () {
    ...
    try {
      ...
      warn(`WanMask - DetectTokensController single call balance fetch failed`, error)
      return
    }

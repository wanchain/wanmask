...
/**
 * Checks whether a given balance of WAN, represented as a hex string, is sufficient to pay a value plus a gas fee
 *
 ...
 * @param {string} txParams.value The value of WAN to send
 * @param {string} hexBalance - A balance of WAN represented as a hex string

...
describe('Confirm Transaction utils', function () {
  ...
  describe('getValueFromWeiHex', function () {
    it('should get the transaction amount in WAN', function () {
      const ethTransactionAmount = utils.getValueFromWeiHex({
        value: '0xde0b6b3a7640000', toCurrency: 'WAN', conversionRate: 468.58, numberOfDecimals: 6,
      })
  ...
  describe('getTransactionFee', function () {
    it('should get the transaction fee in WAN', function () {
      const ethTransactionFee = utils.getTransactionFee({
        value: '0x1319718a5000', toCurrency: 'WAN', conversionRate: 468.58, numberOfDecimals: 6,
      })

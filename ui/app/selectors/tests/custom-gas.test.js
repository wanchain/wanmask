    ...
    const tests = [
      {
        expectedResult: [
          ...
          },
          {
            ...
            feeInPrimaryCurrency: '0.000105 WAN',
      ...
      },
      {
        expectedResult: [
          ...
          {
            feeInPrimaryCurrency: '0.000147 WAN',
          ...
          },
          {
            ...
            feeInPrimaryCurrency: '0.00021 WAN',
            timeEstimate: '~6 min 36 sec',
        ...
        expectedResult: [
          {
            ...
            feeInPrimaryCurrency: '0.00052 WAN',
            gasEstimateType: 'SLOW',
            priceInHexWei: '0x5d21dba00',
          },
          {
            feeInSecondaryCurrency: '$0.16',
            feeInPrimaryCurrency: '0.00063 WAN',
            gasEstimateType: 'AVERAGE',
            priceInHexWei: '0x6fc23ac00',
          },
          {
            feeInSecondaryCurrency: '$0.27',
            feeInPrimaryCurrency: '0.00105 WAN',
            gasEstimateType: 'FAST',
      ...
      },
      {
        expectedResult: [
          ...
          },
          {
            ...
            feeInPrimaryCurrency: '0.00157 WAN',
            gasEstimateType: 'AVERAGE',
            priceInHexWei: '0x1176592e00',
          },
          {
            feeInSecondaryCurrency: '$5.37',
            feeInPrimaryCurrency: '0.0021 WAN',
            gasEstimateType: 'FAST',
